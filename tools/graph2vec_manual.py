import os
import numpy as np
from tools.vec2onehot_manual import vec2onehot
...
dict_NodeName = {"NULL": 0, "VAR1": 1, "VAR2": 2, "VAR3": 3, "VAR4": 4, "VAR5": 5, "S": 6, "S1": 7, "S2": 8, "S3": 9,
                 "S4": 10, "S5": 11, "W": 12, 'W1': 13, 'W2': 14, 'W3': 15, 'W4': 16, 'W5': 17, "C": 18, 'C1': 19,
...
def embedding_node(node_attribute_list):
    ...
    node_embedding = []
    var_embedding = []
    main_point = ['S', 'S1', 'S2', 'S3', 'S4', 'S5', 'W', 'W1', 'W2', 'W3', 'W4', 'W5', 'C', 'C1', 'C2',
                  'C3', 'C4', 'C5']
...
def construct_var_edge_vec(edge_list, node_embedding, var_embedding, edge_embedding):
    ...
    edge_out = []
    node_vec = []
    S_point = ['S', 'S1', 'S2', 'S3', 'S4', 'S5']
    W_point = ['W', 'W1', 'W2', 'W3', 'W4', 'W5']
    C_point = ['C', 'C1', 'C2', 'C3', 'C4', 'C5']
    main_point = ['S', 'S1', 'S2', 'S3', 'S4', 'S5', 'W', 'W1', 'W2', 'W3', 'W4', 'W5', 'C', 'C1', 'C2',
                  'C3', 'C4', 'C5']
