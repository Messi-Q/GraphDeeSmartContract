import os
import numpy as np
from tools.vec2onehot_corenodes_without_edge_167 import vec2onehot
...
def construct_var_edge_vec(edge_list, node_embedding, var_embedding, edge_embedding):
    ...
    edge_vec_length = 52
    var_vec_length = 69
    node_embedding_dim_without_edge = 350
    ...
    for i in range(len(node_embedding)):
        vec = np.zeros(node_embedding_dim_without_edge)
...
if __name__ == "__main__":
    result = "../graph_data/graph_data_corenodes_without_edge_164/result/result.txt"
    vertex_path = "../graph_data/graph_data_corenodes_without_edge_164/node/"
    edge_path = "../graph_data/graph_data_corenodes_without_edge_164/edge/"
