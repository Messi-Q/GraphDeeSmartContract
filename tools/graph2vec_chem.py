...
import json
import numpy as np
from tools.vec2onehot_chem import vec2onehot
...
if __name__ == "__main__":
    v_path = "../graph_data/graph_data_tool_chem_164/node/"
    e_path = "../graph_data/graph_data_tool_chem_164/edge/"

    fileObject = open('../graph_data/graph_data_tool_chem_164/Chem_V1_autoTool.json', 'w')
    LabelOrder_file = open("../graph_data/graph_data_tool_chem_164/new_graph_data_label_SameSettingGCN.txt")  # 合约list
    New_label_file = open("../graph_data/graph_data_tool_chem_164/new_graph_data_label.txt")  # 合约漏洞标签
