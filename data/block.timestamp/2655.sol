...
contract F3Devents {
    ...
    // (FOMO3TEST1d short only) fired whenever a player tries a buy after round timer
    ...
    // (FOMO3TEST1d short only) fired whenever a player tries a reload after round timer
    // hit zero, and causes end round to be ran.
...
contract FOMO3TEST1 is modularShort {
    using SafeMath for *;
...
//==============================================================================
    ...
    /**
     * @dev prevents contracts from interacting with FOMO3TEST1d
     */
    modifier isHuman() {
...
//==============================================================================
        ...
        returns(F3Ddatasets.EventReturns)
    {
        ...
        {
            // This ensures Team Just cannot influence the outcome of FOMO3TEST1D with
