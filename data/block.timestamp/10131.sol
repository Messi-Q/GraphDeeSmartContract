...
contract ICOPreSale is ICO {
	...
	constructor(address _SCEscrow, address _SCTokens, address _SCWhitelist, address _SCRefundVault) public {
		...
		// 2018-05-10: [email protected] Los Hardcap que indicas no son los últimos comentados. Los correctos serían:
		//    Pre-Sale:     8.470 ETH
		//    1st Tier:       8.400 ETH
		//    2nd Tier:     68.600 ETH
...
contract Tokens is HardcodedWallets, ERC20, Haltable {
	...
	constructor(address _addressSCEscrow, address _addressSCComplianceService) public {
        ...
        _totalSupply = 1350000000 ether; // 2018-05-10: [email protected] ...tenemos una emisión de 1.350 millones de Tokens
